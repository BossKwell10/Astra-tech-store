...
n = this, t = function () {
    ...
    var On = m, Mn = m + "__slider", Tn = m + "__track", jn = m + "__list", Fn = m + "__slide", In = Fn + "--clone",
        ...
        __proto__: null, Options: function (t, n, r) {
            ...
            function P(n) {
                ...
                s ? ((d || n.cancelable && O()) && (t = function (n) {
                    if (u.is(ct) || !L) {
                        var t = f === s && a || f, i = M(s) - M(t), t = T(n) - T(t), n = T(n) - T(s) < 200;
                        if (t && n) return i / t
                    }
                    return 0
    ...
    i = function () {
        ...
        }]) && At(n.prototype, r), t && At(n, t), Object.defineProperty(n, "prototype", {writable: !1}), i
    }();
